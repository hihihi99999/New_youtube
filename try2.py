...
DEVELOPER_KEY = "AIzaSyB85cKXHefo5zPt_3n9DPIlE1CRSnps5FQ"
...
def get_results(df_video, threshold=5000):
    ...
    for item in subscriber_list['items']:
        ...
        if len(item['statistics']) > 0:
            ...
            subscriber['subscriberCount'] = int(
    ...
    results.loc[:, ['video_id', 'title', 'viewCount',
                    'subscriberCount', 'channel_id']]
    return results
...
threshold = st.sidebar.slider('登録者数', 100, 10000, 5000)
